-- V4__seed_notification_templates_r9i1.sql
-- Migración de datos idempotente para conservar V2 inmutable.
-- Actualiza/crea plantillas de notificación usadas por la versión estable R9-I.1.
-- No crear/alterar/droppear tablas aquí.

INSERT INTO NOTIFICATION_CHANNEL_CONFIG
(CODIGO, TIPO_CANAL, NOMBRE, CONFIG_JSON)
VALUES
...
(CODIGO, TIPO_EVENTO, TIPO_CANAL, ASUNTO_TEMPLATE, CUERPO_TEMPLATE, IDIOMA)
VALUES
...
('TRANSFER_SENT_EMAIL','TRANSFER_SENT','EMAIL','Transferencia enviada','Estimado/a {{nombre}}, se envió una transferencia por {{monto}} desde la cuenta {{cuentaOrigen}} hacia {{cuentaDestino}}. Comprobante: {{comprobante}}.','es-EC'),
('TRANSFER_RECEIVED_EMAIL','TRANSFER_RECEIVED','EMAIL','Transferencia recibida','Estimado/a {{nombre}}, recibió una transferencia por {{monto}} en la cuenta {{cuentaDestino}} desde {{ordenante}}. Comprobante: {{comprobante}}.','es-EC'),
